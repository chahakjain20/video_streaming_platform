...
import { SERACH_MOVIE_URL, options } from '../utils/constant';
...
const SearchMovie = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const res = await axios.get(`${SERACH_MOVIE_URL}${searchMovie}&include_adult=false&language=en-US&page=1`, options);
    ...
    <>
      <div className='flex justify-center pt-[10%] w-[100%]'>
        <form onSubmit={submitHandler} className='w-[50%]'>
          ...
          <div className='flex justify-between shadow-md border-gray-200 rounded-lg w-[100%] p-2'>
